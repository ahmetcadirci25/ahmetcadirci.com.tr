...
- [Windows](https://github.com/TheTorProject/gettorbrowser/releases/download/v8.0.2/torbrowser-install-8.0.2_tr.exe){:target="_blank"}{:rel="nofollow noopener noreferrer"} 
- [OS X](https://github.com/TheTorProject/gettorbrowser/releases/download/v8.0.2/TorBrowser-8.0.2-osx64_tr.dmg){:target="_blank"}{:rel="nofollow noopener noreferrer"} 
- [Linux 32-bit](https://github.com/TheTorProject/gettorbrowser/releases/download/v8.0.2/tor-browser-linux32-8.0.2_tr.tar.xz){:target="_blank"}{:rel="nofollow noopener noreferrer"} 
- [Linux 64-bit](https://github.com/TheTorProject/gettorbrowser/releases/download/v8.0.2/tor-browser-linux64-8.0.2_tr.tar.xz){:target="_blank"}{:rel="nofollow noopener noreferrer"} 
...
[https://check.torproject.org/](https://check.torproject.org/?lang=tr){:target="_blank"}{:rel="nofollow noopener noreferrer"} 
