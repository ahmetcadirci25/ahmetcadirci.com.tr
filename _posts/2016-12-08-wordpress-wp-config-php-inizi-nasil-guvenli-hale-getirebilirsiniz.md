...
![wp-config.php'nin İçeriği](http://ahmetcadirci.com.tr/images/galeri/wordpress-wp-config-php.png "wp-config.php'nin İçeriği")
...
![WordPress Secret Key Salt](http://ahmetcadirci.com.tr/images/galeri/wordpress-secret-key-salt.png "WordPress Secret Key Salt")
...
![WordPress Tablo Ön Eki](http://ahmetcadirci.com.tr/images/galeri/wordpress-tablo-on-eki.png "WordPress Tablo Ön Eki")
