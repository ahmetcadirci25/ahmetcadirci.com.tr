...
tags : [Wordpress, Wordpress Optimizasyon]
cover: "assets/images/wordpress-wp-config-php-inizi-nasil-guvenli-hale-getirebilirsiniz.png"
class: post-template
subclass: 'post'
author: ahmet
---
...
![wp-config.php'nin İçeriği](https://ahmetcadirci.com.tr/assets/images/galeri/wordpress-wp-config-php.png "wp-config.php'nin İçeriği")
...
![WordPress Secret Key Salt](https://ahmetcadirci.com.tr/assets/images/galeri/wordpress-secret-key-salt.png "WordPress Secret Key Salt")
...
![WordPress Tablo Ön Eki](https://ahmetcadirci.com.tr/assets/images/galeri/wordpress-tablo-on-eki.png "WordPress Tablo Ön Eki")
