...
![GitKraken Feature]({{site.url}}/images/galeri/finish-feature.gif "GitKraken Feature")

<p>Özelliğini geliştirir ve onu temizler.</p>

### Release 

![GitKraken Release]({{site.url}}/images/galeri/finish-release.gif "GitKraken Release")

Release `master` ve `develop` geliştirir ve birleştirir.

### Hotfix

![GitKraken Hotfix]({{site.url}}/images/galeri/finish-hotfix.gif "GitKraken Hotfix")
