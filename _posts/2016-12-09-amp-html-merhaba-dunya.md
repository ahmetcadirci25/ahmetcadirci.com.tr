...
AMP HTML dosyanızın geçerli AMP HTML olup olmadığını kontrol etmek için [AMP Validator](https://validator.ampproject.org/){:target="_blank"}{:rel="nofollow noopener noreferrer"}'ı kullanabilirsiniz. AMP HTML URL'sinin sonunu `#development=1` eklemeniz yeterlidir. Doğrulama hataları Javascript konsolunda yazdırılacaktır. AMP ile oluşturulan bu web sitesini kullanarak deneyebilirsiniz.
