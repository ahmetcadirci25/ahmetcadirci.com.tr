...
{% include picture.html image="/images/galeri/mount-taraki-dagi.png" imagealt="500px.com'da Ronnie Li tarafından Mt Taranaki" %}
...
{% include picture.html image="/images/galeri/hobbit-ormani.png" imagealt="500px.com'da Andrea Iorio tarafından Hobbit Forest" %}
...
{% include picture.html image="/images/galeri/yongbi-reservoir.png" imagealt="500px.com'da Tiger Seo tarafından pano_1" %}
...
{% include picture.html image="/images/galeri/entrance.png" imagealt="500px.com'da Tiger Seo tarafından Entrance" %}
...
{% include picture.html image="/images/galeri/wanaka-agaci.png" imagealt="500px.com'da Ronnie Li tarafından Wanaka tree" %}
...
{% include picture.html image="/images/galeri/leoti-supercell.png" imagealt="500px.com'da Jay Bell tarafından Leoti Supercell Panorama 1" %}
...
{% include picture.html image="/images/galeri/tuz-goleti.png" imagealt="500px.com'da Tiger Seo tarafından Salt pond" %}
...
{% include picture.html image="/images/galeri/magna-mortem.png" imagealt="500px.com'da Josh Wallace tarafından Magna Mortem" %}
...
{% include picture.html image="/images/galeri/volkan.png" imagealt="500px.com'da Marco Calandra tarafından Inferno" %}
...
{% include picture.html image="/images/galeri/erozyon.png" imagealt="500px.com'da Lorenzo Nadalini tarafından Erosion" %}
...
{% include picture.html image="/images/galeri/nostalji.png" imagealt="500px.com'da Isabella Tabacchi tarafından Nostalgia" %}
