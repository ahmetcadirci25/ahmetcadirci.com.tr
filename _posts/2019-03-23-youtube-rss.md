...
1. Abonelikleri Yönet sayfanızın altındaki [Abonelikleri dışa aktar](https://bit.ly/36mPSuR){:target="_blank"}{:rel="nofollow noopener noreferrer"}'ı tıklayarak OPML dosyasını indirin. Bu `subscription_manager.xml` isimli bir dosya indirecektir.
